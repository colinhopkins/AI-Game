...
class Task3 extends FunSuite {
  ...
  test("Test 1") {
    ...
    val result = player.distanceAvoidWalls(gameState, new GridLocation(8, 1), new GridLocation(8, 3))
    assert(result == 2)
  ...
  test("Test 2") {
    ...
    val player: AIPlayer = new AIPlayer("1")
    val result = player.distanceAvoidWalls(gameState, new GridLocation(5, 5), new GridLocation(7, 5))
    assert(result == 4)
  ...
  test("Test 3") {
    ...
    val player: AIPlayer = new AIPlayer("1")
    val result = player.distanceAvoidWalls(gameState, new GridLocation(4, 2), new GridLocation(6, 0))
    assert(result == 14)
